...
from rape_ocr.export_mapping import build_docx_export_payload, format_date_for_docx
...
class ExportMappingTest(unittest.TestCase):
    def test_maps_rural_fields_to_prototype_docx_fields(self):
        ...
        self.assertEqual(payload.values["R1"], "negative")
        self.assertEqual(payload.values["R2"], "positive")
        self.assertEqual(payload.values["R3"], "negative")
    ...
    def test_maps_ppk_fields_to_prototype_docx_fields(self):
        ...
        self.assertEqual(payload.values["R1"], "negative")
        self.assertEqual(payload.values["R2"], "negative")
        self.assertEqual(payload.values["R3"], "negative")
